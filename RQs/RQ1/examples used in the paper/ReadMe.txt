The following six .csv data files storing the data to plot the figures in the directory figures. In these files, the first column is the $\mathit{ln}(l_B)$, and the second column is the $\mathit{ln}(\mathit{ibans}(l_B))$. Please refer to Figure 5 in our manuscript.
